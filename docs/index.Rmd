...
## Pacote `dados`
- Se quiser reproduzir os exercícios com as bases de dados traduzidas para o português, é possível através da instalação do pacote `dados` (atualmente em desenvolvimento):
...
# RStudio
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("img/intro-rstudio/01-rstudio.png")
```
...
# RStudio
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("img/intro-rstudio/01-rstudio-script.png")
```
Fonte: [SW Carpentry](http://swcarpentry.github.io/r-novice-gapminder/01-rstudio-intro/index.html)
...
knitr::include_graphics("img/intro-rstudio/haydee1.jpg")
```
...
# RStudio
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("img/intro-rstudio/haydee2.jpg")
```
Fonte: [Haydee Svab](https://www.slideshare.net/mobile/haydeesvab/anlise-crtica-de-dados-primeiros-passos-com-r)
...
# RStudio
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("img/intro-rstudio/haydee3.jpg")
```
Fonte: [Haydee Svab](https://www.slideshare.net/mobile/haydeesvab/anlise-crtica-de-dados-primeiros-passos-com-r)
...
# RStudio
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("img/intro-rstudio/haydee4.jpg")
```
Fonte: [Haydee Svab](https://www.slideshare.net/mobile/haydeesvab/anlise-crtica-de-dados-primeiros-passos-com-r)
...
# RStudio
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("img/intro-rstudio/haydee5.jpg")
```
Fonte: [Haydee Svab](https://www.slideshare.net/mobile/haydeesvab/anlise-crtica-de-dados-primeiros-passos-com-r)
...
# RStudio
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("img/intro-rstudio/haydee6.jpg")
```
Fonte: [Haydee Svab](https://www.slideshare.net/mobile/haydeesvab/anlise-crtica-de-dados-primeiros-passos-com-r)
...
# RStudio
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("img/intro-rstudio/haydee7.jpg")
```
Fonte: [Haydee Svab](https://www.slideshare.net/mobile/haydeesvab/anlise-crtica-de-dados-primeiros-passos-com-r)
...
```{r echo=FALSE, out.width="90%"}
knitr::include_graphics("img/intro-rstudio/haydee8.jpg")
```
Fonte: [Haydee Svab](https://www.slideshare.net/mobile/haydeesvab/anlise-crtica-de-dados-primeiros-passos-com-r)
...
- Um gráfico feito com ggplot2 é uma combinação de **camadas**.
